...
fn update_config() {
    ...
    assert_eq!(config.eclip_daily_reward.u128(), 1_000_000_000u128);
    assert_eq!(
    ...
    let new_config = UpdateConfigMsg {
        ...
        lp_contract: Some(Addr::unchecked("new_lp_contract".to_string()).to_string()),
        ...
        converter: Some(Addr::unchecked("new_converter".to_string()).to_string()),
...
fn lp_staking() {
    ...
    suite
        .mint_native(suite.lp_staking(), suite.eclip(), 5_000_000_000)
        .unwrap();
