...
use equinox_msg::{
    ...
    lp_staking::{
        ...
        QueryMsg as LpStakingQueryMsg, RewardConfig,
...
fn store_astro_generator(app: &mut App) -> u64 {
    let contract = Box::new(
        ContractWrapper::new_with_empty(
            astro_generator::contract::execute,
            astro_generator::contract::instantiate,
            astro_generator::contract::query,
        )
    );
