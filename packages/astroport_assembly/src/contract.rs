...
pub fn instantiate(
    ...
    // let staking_config = deps.querier.query_wasm_smart::<staking::ConfigResponse>(
    //     &msg.staking_addr,
    //     &staking::QueryMsg::Config {},
    // )?;
    ...
    let config = Config {
        xastro_denom: String::default(), // staking_config.xastro_denom,
        xastro_denom_tracking: String::default(), // tracker_config.tracker_addr,
